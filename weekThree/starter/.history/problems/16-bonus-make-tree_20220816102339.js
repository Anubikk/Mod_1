...
const makeTree = (categories, parent) => {
  ...
  if (categories[0].parent === parent) { // if the first element's parent property matches the parent property, call makeTree on the first element and concatenate it with the rest of the array
