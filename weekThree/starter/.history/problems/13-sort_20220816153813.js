...
const sort = (nums, sorted = []) => nums.length === 0 ? sorted : smallest = nums.reduce((acc, curr) => curr < acc ? curr : acc), sorted.push(smallest), nums.splice(nums.indexOf(smallest), 1), sort(nums, sorted);
