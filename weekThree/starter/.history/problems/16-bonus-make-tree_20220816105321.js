...
const makeTree = (categories, parent) => {
  if (categories === []) { // base case - if the array is empty, return an empty object
    return {};
  }
  if (categories[0].parent === parent) { // if the first element's parent property is equal to the parent property, call makeTree on the first element and concatenate it with the rest of the array
