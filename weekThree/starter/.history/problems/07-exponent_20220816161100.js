...
const exponent = (num, power) => {
  ...
  return num * exponent(num, power - 1); // recursive case - multiply the base number by the exponent and call exponent with the base number and the power - 1 that
}

//

//second attempt one line - recursive
const exponent = (num, power) => power === 0 ? 1 : power < 0 ? (1 / num) * exponent(num, power + 1) : num * exponent(num, power - 1);
