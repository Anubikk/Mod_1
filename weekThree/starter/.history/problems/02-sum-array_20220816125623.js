...
function sumArray(nums) {
  if(!nums.length) return 0 // if the array is empty, return 0 - base case
  return num[0] + sumArray(nums.slice(1)) // return the first element plus the recursive call - recursive call with the next element in the array removed from the array
}
