...
//third attempt - recursive **Cleanest**
function sumArray(nums) {
  if(!nums.length) return 0 // if the array is empty, return 0 - base case
  return nums[0] + sumArray(nums.slice(1)) // return the first element plus the recursive call - recursive call
}

//fourth attempt one-liner - recursive
