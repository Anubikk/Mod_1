...
//third attempt one liner recursive
const iceCreamShop = (flavors, favorite) => flavors.length ? flavors[0] === favorite || iceCreamShop(flavors.slice(1), favorite) : false;
