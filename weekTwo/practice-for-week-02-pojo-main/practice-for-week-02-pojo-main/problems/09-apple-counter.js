...
function appleCounter(appleObj) {
 ...
 for (let key in appleObj){ //loop through the object
  key = key.toLowerCase(); //convert the key to lower case
  if (key.indexOf("apple") > -1) { //if the key contains the word "apple"
