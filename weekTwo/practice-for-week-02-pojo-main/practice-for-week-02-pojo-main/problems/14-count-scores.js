...
function countScores(people) {
  ...
  if (scoresObj[name]) { //if the name is in the object
    scoresObj[name] += score; //increment the value
  } else{ //if the name is not in the object
    scoresObj[name] = score; //set the value to the score
  }
  }

  return scoresObj; //return the object
}
