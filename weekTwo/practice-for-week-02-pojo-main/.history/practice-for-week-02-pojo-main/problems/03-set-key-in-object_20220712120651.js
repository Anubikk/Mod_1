...
function setKeyInObject(obj, string, value) {
  let key = string; //sets key value as the string input
  obj[key] = value; //sets the value of key to the input of value
  return obj; // returns the key value pair of declared object
}
