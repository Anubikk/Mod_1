...
function appleCounter(appleObj) {
  ...
  //set forLoop params to iterate through the keys of our object.
 for (let key in appleObj){
  //set search specs to set all keys to lower case.
  key = key.toLowerCase();
  //set our if conditionals to trigger count if our key index contains "apple"
  if (key.indexOf("apple"))
