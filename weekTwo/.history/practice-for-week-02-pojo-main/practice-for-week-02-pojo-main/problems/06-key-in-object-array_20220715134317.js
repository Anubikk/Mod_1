...
function keyInObjectArray(objArray, keyString) {
  let keyFound = false;// sets a default value of false to toggle in place of .forEach.
  ...
  return keyFound;// returns boolean if input of keyString is found within object.
