...
function countDownTimer(num) { //create a function that takes in a number argument
  if (num === 0) return "Happy New Year!"; //if the number is 0 return "Happy New Year!"
  const _count = () => { //create a function that returns a function
    num -= 1; //decrement the number
    if (num <= 0) { //if the number is less than or equal to 0
      return "Happy New Year!"; //return "Happy New Year!"
    } else { //if the number is greater than 0
      return _count; //return the function
    }
  };
  return _count; //return the function
}
