...
const recVolume = (height) => {
  let volume = height; //create a variable to store the volume
  return function(width) { //return a function
    return function(length) { //return a function
      return volume * width * length; //return the volume
