...
function sandwichMaker() {
    let ingredients = ["tomato"]; //create a variable to store the ingredients
    return function(ingredient) { //return a function that takes in an argument
        ingredients.push(ingredient); //add the argument to the ingredients
        return `One sandwich with ingredients.join(" and ")}`; //return the ingredients
    }
}
