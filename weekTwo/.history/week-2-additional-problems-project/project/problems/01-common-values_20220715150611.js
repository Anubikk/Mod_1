...
const commonValues = (obj1, obj2) => {
    ...
    for (let key in obj1) { //loop through the object with for in
        if (obj2[key]) { //if the key is in the second object
            common.push(obj1[key]); //add the value to the common array
        }
    }
    return common; //return the common array
