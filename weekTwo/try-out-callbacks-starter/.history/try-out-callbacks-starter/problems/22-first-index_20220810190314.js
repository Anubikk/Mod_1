...
let firstIndex = function(array, cb) {
   return array.findIndex(cb); //returns the index of the first element of the array that results in true when passed into the callback. If no elements of the array result in true, then the function should return -1.
}
