...
let sentenceMapper = function(sentence, cb) {
    return sentence.split(" ").map(word => cb(word)).join(" "); //returns a new sentence where every word of the original sentence becomes the result of passing the word to the callback
}
