...
let count = function(array,cb) {
    //return the number of elements of the array that return true
    //create a count variable
    let count = 0;
    array.forEach(function(ele) { //create a for loop to use CB to add to count if ele is true.
        if (cb(ele)) {
            count ++;// add to count if true
};
    })
