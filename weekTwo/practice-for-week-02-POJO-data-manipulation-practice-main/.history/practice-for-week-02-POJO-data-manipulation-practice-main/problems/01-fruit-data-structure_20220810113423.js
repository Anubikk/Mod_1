...
// Return one object at the given index from the
// fruits array. The function should have two parameters, the array and the
// index of the item.
...
//return a list of all of the keys for each fruit object using a helper function.
function getFruitKeys(fruits) {
   return Object.keys(firstFruitObject)
    }
}
...
function getNutritionsKeys(fruits) {
    for (let i = 0; i < fruits.length; i++) {
        return Object.keys(fruits[i].nutritions);
    }
}
