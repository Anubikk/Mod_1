...
1) the object contains the 'city', 'country', and 'monthlyAvg' keys2) returns the correct object for the second instance of the duplicated city
const returnDuplicate = (climateData) => {
    let duplicate = {}
    climateData.find(city => {
