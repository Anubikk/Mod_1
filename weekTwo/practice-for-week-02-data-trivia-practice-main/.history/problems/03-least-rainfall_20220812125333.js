...
// const leastRainfall = (month) => {
//     const cities = climateData.map(city => {
//         return {
//             city: `${city.city}, ${city.country}`,
//             totalRainfall: city.rainfall[month].reduce((a, b) => a + b)
//         }
//     }).sort((a, b) => a.totalRainfall - b.totalRainfall)
//     return cities.filter(city => city.totalRainfall < 10)
// }
